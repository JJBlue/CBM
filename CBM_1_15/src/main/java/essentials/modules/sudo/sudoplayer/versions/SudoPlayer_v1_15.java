...
public class SudoPlayer_v1_15 extends CraftPlayer implements SudoPlayerInterface {

	public static Player createSudoPlayer(CommandSender usedSudo, Player player) {
		return new SudoPlayer_v1_15(usedSudo, player);
	}
	
	public static Player createSudoPlayer(CommandSender usedSudo) {
		return new SudoPlayer_v1_15(usedSudo);
	}
	...
	public SudoPlayer_v1_15(CommandSender usedSudo, Player player) {
		super(
	...
	public SudoPlayer_v1_15(CommandSender usedSudo) {
		super(
				(CraftServer) usedSudo.getServer(),
	...
	public SudoPlayer_v1_15 setSilentOutputMessage(boolean silent) {
