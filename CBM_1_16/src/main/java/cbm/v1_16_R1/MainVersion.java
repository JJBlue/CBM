...
import cbm.v1_16_R1.modules.sudo.SudoPlayer_Impl;
import cbm.v1_16_R1.utilitiesvr.bukkit.BukkitUtilities_Impl;
import cbm.v1_16_R1.utilitiesvr.chat.ChatUtilities_Impl;
import cbm.v1_16_R1.utilitiesvr.nbt.NBTUtilities_Impl;
import cbm.v1_16_R1.utilitiesvr.player.PlayerUtilities_Impl;
import cbm.v1_16_R1.utilitiesvr.sign.SignUtilities_Impl;
...
public class MainVersion {
	public static void init() {
		...
		if(version != PackageVersion.v1_16_R1) return;
