...
public class SudoPlayer extends CraftPlayer {
	...
	public SudoPlayer(CommandSender usedSudo, Player player) {
		super(
	...
	public SudoPlayer(CommandSender usedSudo) {
		super(
			(CraftServer) usedSudo.getServer(),
	...
	public SudoPlayer setSilentOutputMessage(boolean silent) {
